...
<div class="site-blocks-cover overlay" style="background-image: url('images/hero_1.jpg');" data-aos="fade" data-stellar-background-ratio="0.5">
	...
	<tr>
	<td>
  <input type="checkbox" name="vehicle1" value="Bike">영화 <br>
  </td>
  <td>
    <input type="checkbox" name="vehicle2" value="Car">통신사&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
    </td>
    <td>
  <input type="checkbox" name="vehicle2" value="Car">대중교통          &nbsp;&nbsp;&nbsp;   <br>
  </td>
  <td>
    <input type="checkbox" name="vehicle2" value="Car">쇼핑               <br>
    </td>
    	</tr>
    	<tr>
    	<td>
      <input type="checkbox" name="vehicle2" value="Car">온라인쇼핑    &nbsp;&nbsp;     <br>
      </td>
      <td>
        <input type="checkbox" name="vehicle2" value="Car">외식              <br>
        </td>
        <td>
        <input type="checkbox" name="vehicle2" value="Car">기타                <br>
        </td>
        <td>
        <input type="checkbox" name="vehicle2" value="Car">기타                <br>
        </td>
