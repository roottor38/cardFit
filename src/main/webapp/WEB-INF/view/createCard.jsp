			...
			<form action="/createCard" method="post" encType="multipart/form-data">
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							<td>카드이름</td>
							<td colspan="2"><input type="text" placeholder="체크카드이름 "
								name="cardname" class="form-control" /></td>
						</tr>
						<tr>
							<td>이용조건</td>
						...
						<tr>
							...
							<input type="text" type="text" hidden="hidden" name="name" id="name" class="form-control"
							value="">
							</input>
				...
				<input type="submit" class="btn btn-search btn-primary btn-block"
					value="register"  onclick="saveFile()">
